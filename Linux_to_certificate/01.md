...
+ [8. Права доступа (rwx)](#9-права-доступа-rwx)
...
Шпаргалка по редактору Nano (на английском  языке): https://stepik.org/media/attachments/lesson/1101189/Cheatsheet_for_GNU_nano.pdf <br>
...
top –o PID - запустить утилиту top с сортировкой по полю PID
